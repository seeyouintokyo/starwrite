...
每个文章项目都会生成 `DELIVERY.md`，用可点击的绝对本地链接列出研究过程与来源、事实卡片、文章母稿、3:4 卡片、公众号缩略封面、公众号 HTML、短视频脚本、录屏 HTML 和草稿创建状态。没有使用的模块也会标明原因；Key、App Secret 与草稿 `media_id` 不会写入交付清单。
